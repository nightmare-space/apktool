...
public class ApkOptions {
    ...
    public String frameworkFolderLocation = "/data/data/com.nightmare/files/Apktool/Framework";
    public String frameworkTag = null;
    @SuppressLint("SdCardPath")
    public String aaptPath = "/data/data/com.nightmare/files/Apktool/aapt";
